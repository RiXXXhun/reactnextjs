      ...
      <SignInContainer direction="column" justifyContent="center" sx={{ mt: "100px", }}>
        <Card variant="outlined">
          ...
          <Box component="form" onSubmit={handleSubmit} noValidate sx={{ display: "flex", flexDirection: "column", width: "100%", gap: 2 }}>
            <FormControl>
              <FormLabel htmlFor="username" sx={{ color: "white" }}>felhasználónév megváltoztatása</FormLabel>
              <TextField
                error={usernameError}
                id="username"
                name="username"
            ...
            <FormControl>
              <FormLabel htmlFor="email" sx={{ color: "white" }}>Email megváltoztatása</FormLabel>
              <TextField
                error={emailError}
                id="email"
                type="email"
            ...
            <FormControl>
              <FormLabel htmlFor="securityQuestionAnswer" sx={{ color: "white" }}>Biztonsági kérdés válaszának a megváltoztatása</FormLabel>
              <TextField
